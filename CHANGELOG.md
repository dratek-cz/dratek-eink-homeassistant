...
### Opraveno
- **Kliknutí na displej v seznamu otevíralo pořád ten samý displej.** Panel má dvě odpovědi na otázku „o který displej jde": vybraný displej a displej, pro který se právě kreslí náhled (seznam jich vykresluje několik najednou, každý s vlastní velikostí a paletou). Kreslení si tu druhou hodnotu ukládalo a v `finally` vracelo zpět – jenže vykreslovače jsou asynchronní a dva průchody se běžně překrývají: druhý si zapamatuje adresu prvního jako „předchozí" a vrátí ji zpátky poté, co ji první už uklidil. Hodnota tak zůstala natrvalo viset na displeji, na který se nikdo nedíval, a všechno, co se přes ni ptalo – nadpis, velikost, paleta, orientace, náhled, přiřazené šablony – od té chvíle odpovídalo za něj. Rozsah kreslení se nově drží v zásobníku a odebírá se podle identity, takže se rozmotá při libovolném prokládání.
- **Nastavení jednoho displeje se ukládalo pod adresu jiného.** Totéž zaseknutí, ale s horším koncem: ukládání pracovního návrhu si cíl zjišťovalo stejnou cestou, takže zapsalo stav otevřeného displeje do konceptu toho zaseknutého. Změna Meteoradaru na jednom displeji se tímhle skutečně propsala do druhého. Zápisové cesty teď adresují výhradně vybraný displej a fronta ukládání navíc odmítne zapsat koncept pod jinou adresu, než která je načtená.
- **Náhled Meteoradaru ukazoval mapu jiného displeje.** Vykreslený radarový snímek se držel v jediné přihrádce pro celý panel a blok ho kreslil bez ověření, komu patří. Nastavíte ČR na jednom displeji, Evropu na druhém, vrátíte se na první – a po celou dobu, než doběhne nové stažení, se kreslila Evropa, přestože se na displej odesílala ČR. Snímky se nově ukládají podle klíče, který nese stát, přepínače srážek a větru i geometrii bloku; když pro daný displej snímek ještě není, nakreslí se placeholder místo cizí mapy. Přepínání mezi displeji je tím zároveň okamžité, protože se snímek nemusí stahovat znovu.
- **Dlaždice šablony v katalogu zamrzla na první zobrazené zemi.** Hotové vykreslení dlaždice se pamatovalo pod klíčem „šablona + rozměr + paleta", tedy bez čehokoli, co patří konkrétnímu displeji. Jakmile se dlaždice Meteoradaru jednou nakreslila, ukazovala tu samou zemi na všech displejích stejné velikosti až do obnovení stránky – a změna státu na otevřeném displeji nepřekreslila ani jeho vlastní dlaždici. Klíč nově nese otisk nastavení displeje.

### Přidáno a vylepšeno
- **Displej, který se jednou neozve, už se nehlásí jako nedostupný.** Displej kvůli baterii inzeruje jen občas a sken gatewaye je okno pár sekund, takže minutí jednoho průchodu neříká skoro nic – karta přesto překlopila na „Čekám na signál" u displeje, který normálně přijímal zápisy. Volba trasy si dál vede svoje („v tomhle průchodu jsme ho neslyšeli", a podle toho řadí trasy), ale uživateli se hlásí až displej, který mlčí déle než tři minuty. Popisek zároveň říká, jak dlouho: „naposledy se ohlásil před 20 s", nebo „Displej se neohlásil 7 min".
- Sken za tlačítkem Obnovit poslouchá 8 sekund místo 5. Je to ten sken, na který někdo čeká; sken na pozadí zůstal krátký, ten má za sebou paměť posledních pozorování.
- **Nahrání do nedostupného displeje počká ve frontě.** Dosud takové odeslání rovnou selhalo a práce byla pryč. Nově se úloha podrží, odešle se, jakmile se displej zase ohlásí (do sekundy po jeho zachycení skenem, jinak se to zkusí jednou za minutu), a nejdéle 24 hodin – pak se vzdá. Ve frontě je vidět jako **Čeká na displej** i s vysvětlením a jde ji po celou dobu zrušit tlačítkem, které tam už bylo.
- Podrží se jen to, co dává smysl: ruční nahrání, které se k displeji vůbec nedostalo. Selhání uprostřed přenosu je skutečná chyba a hlásí se jako chyba, chyba na straně gatewaye má vlastní přepnutí na jinou trasu a automatická aktualizace má vlastní další tik – podržená by po návratu displeje nakreslila hodinu starý obrázek.
- Přenos, který se k displeji nedostal, už neaktivuje pauzu na fyzické překreslení e-inku. Žádné překreslení se nekonalo, a čekající nahrání kvůli té pauze po návratu displeje ještě 6–15 sekund stálo.

## [0.1.359] - 2026-09-02

### Firmware gatewaye 0.1.65
- Endpoint `/api/led` byl z gatewaye odstraněn spolu s kontrolkou displeje; nic ho už nevolá. Přibalené binárky jsou přeložené z tohoto zdroje. Na chování stávajících gatewayí to nic nemění – pokud vám 0.1.64 běží, přeflashování nic nezískáte, jen panel bude verzi hlásit jako neaktuální.

### Odstraněno
- **Kontrolka displeje („najdi mě") je pryč celá**: postupně se ukázalo, že ji hardware neumí. Na čtyřech kusech napříč SDK 46, 51 i 75 displej příkaz po Bluetooth přijme, ale nepotvrdí ho a nic se nerozsvítí – viz 0.1.358, kde se odmítnutí začalo alespoň pamatovat, aby se integrace neptala pořád dokola. Funkce, která u žádného displeje nefunguje, ale nemá být ani zapamatovaná, ani schovaná: odešly WebSocket příkazy `dratek_eink/identify`, `set_rgb_led` a `flash_identify`, jejich obsluha v přenosové vrstvě, `/api/led` v gatewayi, tlačítko v dlaždici displeje i zbytky ovládání RGB diody v designeru, které tam po dřívějším odstranění zůstaly viset bez markupu. Ubylo tím zhruba 700 řádků a jedna cesta, kterou se dalo sáhnout na displej.
- Fronta přenosů tím ztratila výjimku pro „operace, které nekreslí pixely" – žádná taková už neexistuje, takže se pauza na fyzické překreslení e-inku řeší jednotně pro všechny zápisy.

### Vylepšeno
- **Ikony počasí mají čistý obrys**: tloušťka obrysu se zadávala v jednotkách kreslicího plátna, tedy jako pevný zlomek ikony – 1,5 z plátna 17 je zhruba 9 % šířky. Obrys se proto zvětšoval spolu s ikonou a na velkém displeji z něj byla skoro pětipixelová černá masa, která sežrala kresbu uvnitř. Jednotlivé části navíc měly tři různé tloušťky (1,5 / 1,1 / 0,85), takže vnější mrak byl orámovaný silněji než vnitřní a ikona se četla jako dvě slepené kresby. Obrys je nově konstantní v pixelech a pro všechny části stejný.
- **Malé ikony přešly na perokresbu**: rastrování mraku má smysl, dokud je z čeho dělat tón. Pod třicet pixelů je šedá `#d4d4d4` rozházená zhruba do každého šestého pixelu, což se uvnitř obrysu čte jako špína, ne jako stín – malé ikony se proto kreslí bíle a nesou je jen obrysy. Mraky se od sebe pořád poznají tvarem.
- Obrys zároveň nesmí být tenký: všechno se nakonec převádí na čistou černou a bílou a tah pod zhruba dvěma pixely se vyrastruje do šedi, kterou rozptyl chyby rozseká na tečky. Tenký obrys pak nevypadá jemně, ale roztrhaně – proto konstantních 2,4 px, ověřeno proti přerušování.
- **Nastavení šablony neukazuje jednu chybějící věc jako tři**: průvodce zjišťuje přítomnost integrace podle domény entity, jenže alternativy doménu sdílejí – Met.no, OpenWeatherMap i AccuWeather jsou `weather`. Vypsané jako tři samostatné karty byly špatně v obou směrech: bez jediné z nich svítily tři červené odznaky „Chybí“ pro jeden nesplněný požadavek, a po instalaci kterékoli z nich zezelenaly všechny tři, tedy i ty, které uživatel nemá. Alternativy jsou teď jeden požadavek s jedním stavem („Zdroj předpovědi počasí“) a možnostmi vypsanými uvnitř. Týká se devíti šablon – počasí, kalendář, zahrada, zásilka, zabezpečení, solár, topení, pračka a kvalita vzduchu.
- U Obýváku a Vody zůstávají položky oddělené schválně: „Senzor teploty a vlhkosti“ a „Senzor CO₂“ jsou dvě různá měření, a Utility Meter z odečtu vodoměru teprve počítá denní spotřebu – sloučit je by požadavek neujasnilo, ale schovalo.
- Oba průvodci nastavením (starší dialog i panel v nastavení displeje) měly vlastní kopii té detekce, takže oprava jednoho tiše minula druhý. Nově ji sdílejí.
- **Upozornění na nenastavenou šablonu je jen na jednom místě**: vrstva „Šablona není nastavená“ se malovala i přes náhled fyzického displeje v nastavení displeje. Popisovala tam obrázek panelu místo toho, co je vlastně nenastavené, a na jedné obrazovce to stálo dvakrát – jednou na kartě šablony v seznamu a podruhé přes náhled. Náhled teď ukazuje šablonu a upozornění nese karta v seznamu šablon. Odešlo s ním i CSS, které tu vrstvu proti náhledu zmenšovalo (kontejnerový dotaz a jeho `clamp` pravidla).
- **Levý sloupec Meteoradaru se dá přečíst**: hodina i teplota se dosud vykreslovaly vycentrované do sloupce vedle ikony, takže každý řádek začínal jinde – „9 °C" a „−11 °C" jsou tři znaky od sebe – a předpověď dolů sloupcem působila jako rozsypané číslice. Obě hodnoty teď sdílejí jednu levou hranu, teplota nese váhu a hodina je vedle ní jen popisek, ne rovnocenný údaj. Aktuální teplota dostala popisek **TEĎ** a linku pod sebou: dřív to bylo jen větší číslo bez vysvětlení, k nerozeznání od předpovědního řádku, který se náhodou vykreslil ve větší velikosti.
- Řádky předpovědi nově dorovnají výšku sloupce. Popisek a linka nad nimi zabraly přesně tolik místa, že při pevné výšce řádku vypadla poslední hodina, která by se tam ještě vešla, a zbytek zůstal jako mrtvé pásmo u dolní hrany.
- **Šipky větru na radaru už nejsou uřezané**: šipky se kreslily v plné délce a teprve pak se ořízly obrysem země, takže z každé, která dosáhla na hranici, zbyl pahýl nebo hlava bez násady – a mřížka vzorků klade u každé reálné země několik bodů blízko okraje. Šipka se teď umisťuje celá: nevejde-li se, zkrátí se (na 78 %, 60 %, nakonec 45 %), a teprve když se nevejde ani nejmenší, přeskočí se. Kdyby výřez odmítl úplně všechny – malá země nebo mřížka, jejíž body padnou samé k okraji – nakreslí se původním způsobem, aby z mapy vítr nezmizel.
- **Rychlost větru jde konečně odečíst**: dosud ji nesla jen délka šipky v rozsahu 0,72–1,42, takže vánek a vichr se lišily zhruba o třetinu šipky – nic, co by šlo přečíst z e-inkového panelu. Nově se s rychlostí mění i tloušťka čáry, která zmenšení na velikost displeje přežije podstatně lépe. Hlava šipky je zároveň zhruba tak široká jako dlouhá; dřív to byl dlouhý úzký hrot na vláskové násadě, ze kterého po zmenšení zůstal plovoucí trojúhelník.
- **Nastavení Meteoradaru vypadá jako zbytek panelu**: karta s volbami měla natvrdo zapsané `rgba(255,255,255,0.03)` na pozadí a `rgba(255,255,255,0.1)` v rámečku – barvy, které existují jen na tmavém motivu, takže ve světlém motivu Home Assistantu byla karta i její rámeček prakticky neviditelné. Volby teď používají proměnné motivu jako všechno ostatní, emoji 🌧️ a 💨 nahradily ikony `ha-icon`, každá volba má vlastní popis („Šipky ukazují, kam vítr fouká“) a nadpis karty říká „Radarová mapa“, protože se v ní nevybírá jen stát.
...
- Název mDNS instance je nově odvozený od názvu hostitele dané desky, takže si dvě gatewaye v jedné síti nekolidují a Home Assistant si kvůli nim nezaloží další záznamy. Přibalené binárky jsou přeložené z tohoto zdroje.

### Přidáno a vylepšeno
- **Cenovka je plnohodnotná regálová cenovka**: k názvu a ceně přibyla pole, bez kterých se cenovka v obchodě neobejde – množství balení, měrná cena za kilo/litr/kus, země původu, třída jakosti, platnost akce, nejnižší cena za posledních třicet dní a klubová cena s věrnostní kartou. Měrná cena se z ceny a množství dopočítá sama („500 g“ + 189,90 dá 379,80 Kč/kg), protože je to přesně ten výpočet, který se při ručním přepisování cenovek plete. Nepovinná pole nemají žádné vzorové hodnoty: údaj jako „I. jakost · ČR“, který by se objevil sám od sebe, by na regál pověsil tvrzení, které nikdo nezadal a u spousty zboží ani neplatí – prázdné pole znamená prázdný řádek. Ke každému údaji jde místo ruční hodnoty připojit entitu Home Assistantu.
- **Cenovka tiskne skutečný čárový kód**: v patičce se dosud vypisovaly jen číslice EAN drobným písmem – informace, kterou žádná čtečka nepřečte a člověk nepotřebuje. Cenovka teď kód opravdu zakóduje: třináct nebo dvanáct číslic jako EAN-13, sedm nebo osm jako EAN-8, cokoli s písmeny jako Code 128, takže projde i vlastní skladové číslo. Čárky se kreslí v celých pixelech displeje a mají skutečnou klidovou zónu – čárka na půl pixelu vyjde šedě, převod do tří barev ji přiklopí k černé nebo bílé, a přesně tak kód přestane jít načíst. Vadnou kontrolní číslici si cenovka dopočítá sama: kód se špatnou poslední číslicí se načte na zboží, které neexistuje, což je horší než cenovka bez kódu. Dialog AKCE / SLEVA rovnou pod polem ukazuje, jaký symbol vznikne a jestli se číslice opravovala.
- **Akce už nezalévá celý štítek červenou**: zapnutá akce dosud vyplnila celou cenovku červeným polem a text z něj vyřízla do bílé. Na panelu, který každý pixel překlápí do jedné ze tří barev, je to nejhorší možné využití třetí barvy – největší možná červená plocha, cena vytištěná „barvou“, kterou panel neumí (je to prosvítající papír), a červený průchod přes celou plochu při každém překreslení. Červená teď označuje jen to, co se změnilo: cenu, přeškrtnutou původní cenu a malý štítek se slevou v procentech. Podklad zůstane bílý, takže cenovka jde přečíst i z druhé strany uličky.
- **Sleva v procentech přímo na displeji**: z původní a akční ceny se dopočítá „−25 %“ a vytiskne se jako červený štítek vedle ceny. To je údaj, který zákazník přečte jako první, a dosud na cenovce nebyl vůbec.
- **Cenovka funguje i na výšku**: na výšku dřív vycházela cena jako drobný text uprostřed prázdné plochy – rozvržení bylo laděné jen na šířku. Měna se na úzkém štítku přesouvá pod cenu, takže číslo dostane celou šířku a vyjde zhruba o třetinu vyšší; čárovému kódu připadne víc místa, protože delší čárky se snímají spolehlivěji.
- **Čárový kód jako samostatný prvek v designeru**: blok „Čárový kód“ přibyl do palety prvků šablon, takže se dá vložit do libovolné vlastní šablony, ne jen do cenovky.
- **Hláška o zablokovaném USB vysvětluje proč**: „Prohlížeč tady k USB nepustí“ dosud jen konstatovala, že je potřeba zabezpečené připojení. Teď ukazuje adresu, na které panel právě běží, vysvětluje, že jde o bezpečnostní pravidlo samotného prohlížeče, které integrace ani Home Assistant nemůžou vypnout, a nabízí tři konkrétní cesty ven seřazené od nejméně práce – nahrání přes zařízení s Home Assistantem, otevření Home Assistantu přes HTTPS, nebo tunel na `localhost` i s hotovým příkazem. Stejně tak hláška o prohlížeči bez Web Serial nově říká, které prohlížeče ho mají.

### Opraveno
- **Gatewaye si přestanou samy zakládat duplicitní záznamy**: firmware ohlašoval přes mDNS u všech desek tentýž pevný název instance „DRATEK eInk gateway“. mDNS ale vyžaduje, aby byl název instance v síti jedinečný, takže druhou desku resolver přejmenoval na „DRATEK eInk gateway-2“ – a Home Assistant, který mDNS nálezy zpracovává úplně sám bez potvrzení, si tu přejmenovanou instanci uložil jako další gateway se jménem, které uživatel nikdy nezadal. Tak vzniknou v seznamu dva až čtyři záznamy pro dvě fyzické desky, aniž by kdokoli cokoli udělal. Firmware teď hlásí jako název instance vlastní název hostitele, který je pro každou desku jiný. **Vyžaduje nahrání nového firmwaru gatewaye 0.1.64 – panel na něj sám upozorní.** Dokud desky běží na starším firmwaru, duplicitní záznamy můžou vznikat dál; integrace už z nich ale neudělá souběžné zápisy do jedné desky.
- **Do jedné gatewaye se už nezapisuje dvakrát naráz**: fronta řadí přenosy podle „zdroje“, a tím bylo `id` uloženého záznamu gatewaye – ne krabička, se kterou ten záznam mluví. Totéž platilo i pro připnutou gateway: ruční odeslání, odeslání návrhu na vybranou gateway i automatický zápis na připnutou trasu si každý skládal vlastní klíč, takže připnutá trasa se neřadila za přenosy poolu do téže desky. Dva záznamy mířící na jednu ESP32 (gateway přidaná ručně a tatáž později nalezená přes mDNS, nebo záznam, který po obnovení DHCP převzal adresu jiného) tak držely dva nezávislé zámky a fronta do jediného rádia zapisovala dvěma přenosy současně. Ve vyexportovaném logu je to vidět na `Connection reset by peer` a na šestnácti `BLE connection failed after retries`. Zdrojem je nově adresa, na kterou se opravdu posílá, takže se dva záznamy jedné gatewaye seřadí za sebe; nezávislé gatewaye běží dál souběžně.
- **Gateway po změně IP nepošle data na starou adresu**: stav gatewaye si po neúspěšném ověření záměrně nechává poslední funkční údaje včetně IP, aby zařízení nezmizelo ze směrování, kdežto mDNS při obnovení DHCP přepíše adresu. Odeslání dávalo přednost naposledy ověřené IP bez ohledu na to, která z těch dvou informací je novější – v logu je jedna gateway posílající během jedné minuty na dvě různé adresy. Ověřená IP se teď použije, jen dokud ji nepřebije novější nález.
- **Nalezení gatewaye na cizí adrese už nenechá duplicitu**: záznam, který následuje změnu adresy, mohl skončit na adrese, kterou už drží jiný záznam. Vkládání gatewaye ručně proti tomu bránilo od začátku; při aktualizaci teď platí totéž. Zahodí se jen záznam, který prokazatelně patří téže gatewayi – dvě skutečně různé gatewaye za jednou adresou zůstanou obě.
- **Meteoradar stahuje jen z RainVieweru a jen ohraničenou odpověď**: adresu dlaždic bral panel z pole `host` uvnitř odpovědi RainVieweru a vkládal ji do požadavku beze změny. O tom, na jakou adresu se Home Assistant připojí, tak rozhodovala vzdálená odpověď – zevnitř domácí sítě a mimo dosah kontrol, které si integrace jinak drží u gatewayí. Hostitel i cesta se teď ověřují, a když neodpovídají, radar ponechá poslední složený snímek. Zároveň dostalo čtení strop: ani index, ani dlaždice se už nenačtou do paměti v libovolné velikosti a příliš velký PNG se odmítne dřív, než se rozbalí na bitmapu.
- **Přepínač akce čte jeden zdroj**: štítek AKCE na kartě displeje a samotná vykreslená cenovka se ptaly dvou různých úložišť ve dvou různých pořadích, takže si protiřečily v obou směrech naráz. Vypnutí přepínače v editoru nechalo cenovku vykreslenou dál v akci (zastaralý plochý klíč v návrhu přebil živý stav editoru) a naopak akce nastavená z karty a následně automaticky uložená nechala svítit štítek nad cenovkou vykreslenou bez ní. Obojí teď odpovídá jedna funkce se stanoveným pořadím: živý stav editoru u otevřeného displeje, pak uložený návrh, pak klíč z verzí před 0.1.356, nakonec navázaná entita.
- **Čárový kód se nekreslí, když by nešel načíst**: na nejužších štítcích vycházel jeden modul na jeden pixel displeje, tedy asi 0,22 mm proti minimu 0,26 mm, které čtečky vyžadují. Takový symbol vypadá správně a načíst se nedá, což je horší než žádný – místo něj se teď vytisknou samotné číslice dost velké na přečtení.
- **Panel po odchodu ze stránky nezůstává viset v paměti**: úklid při odpojení panelu odebíral posluchače změny velikosti okna uloženého ve vlastnosti, kterou nikdy nikdo nenastavil, kdežto skutečně přidaný posluchač byl anonymní, a tedy neodstranitelný. Každé nové otevření panelu tak nechalo ten předchozí – i s načtenými návrhy displejů a bitmapami náhledů – trvale dosažitelný z okna.
- **Z dialogu AKCE / SLEVA se konečně dostanou hodnoty na displej**: nic, co jste do toho dialogu napsali, se na cenovku nikdy nepropsalo. Šablona hledá hodnoty pod klíči odvozenými z popisků proměnných (`price:0-nazev-zbozi`, `price:1-cena` …), kdežto dialog je ukládal pod názvy ikon (`price:tag-outline`, `price:currency-usd` …), které nečte nic. Dialog si své klíče četl zpátky sám, takže po znovuotevření poslušně ukazoval, co jste naposledy napsali, a displej mezitím dál tiskl vzorová jablka. Fungoval jen přepínač akce, ten jde jinou cestou. Klíče se teď odvozují z téhož katalogu jako v rendereru, takže se nemají jak znovu rozejít, a starší návrhy se při prvním uložení převedou.
- **Hodnoty s tečkou se už neztratí**: dialog neukládal ruční hodnoty s předponou `literal:`, kterou používá pole Ruční hodnota v editoru. Cokoli s tečkou – „I. jakost“, „do 15. 9.“, cena s desetinnou tečkou – se proto vyhodnotilo jako identifikátor entity, žádná taková entita neexistovala a na cenovce zůstalo prázdno.
- **Tlačítko AKCE / SLEVA je vidět na hlavní stránce**: na kartě displeje s cenovkou se objevilo, teprve když jste ten displej aspoň jednou otevřeli v editoru, a po obnovení stránky zase zmizelo. Seznam přiřazených šablon se totiž plnil jen pro displej právě otevřený v editoru, kdežto hlavní stránka vykresluje všechny karty. Karty teď čtou uložený návrh displeje, který si seznam šablon nese s sebou.
- **Sleva nastavená z karty nepřepíše jiný displej**: dialog AKCE / SLEVA zapisoval název, ceny i kód nejen do návrhu displeje, ze kterého se otevřel, ale vždycky také do živého stavu editoru. Když byl v editoru otevřený jiný displej, dostal cizí hodnoty a další automatické uložení je tam natrvalo zapsalo.
- **Cena a měna stojí na jedné účaří**: „Kč“ se sázelo o kus níž než samotné číslo a vypadalo to jako chyba vykreslení. Obojí je teď jeden řádek na jedné účaří se správnou mezerou.
- **Cenovka už nedostává žlutý rámeček**: na čtyřbarevných displejích obtahoval společný barevný motiv cenu žlutým rámem. Na regálové cenovce to čte jako zapomenutý zvýrazňovač, ne jako struktura – cenovka je černá, červená a bílá, jako v každém obchodě.
- **Vzorový EAN cenovky je platný**: přednastavené `8594001234567` mělo vadnou kontrolní číslici, takže by se po zakódování vytisklo jinak, než jak stálo v poli. Vzorem je nově `8594001234561`.
...
### Přidáno
- **Rozsvícení kontrolky displeje**: na kartě každého displeje v hlavním seznamu přibyla ikona kontrolky. Kliknutí rozsvítí LED přímo na tom displeji, takže se ve skladu nebo v regálu pozná, o který kus jde. Není to bliknutí, ale přepínač – hledání displeje znamená k němu dojít, tak svítí tři minuty a zhasne sám; druhé kliknutí ho zhasne hned. Příkaz se posílá stejnou cestou jako obrázek: připnutou gatewayí, jinak nejbližší gatewayí, a teprve nakonec Bluetoothem Home Assistantu. Právě proto to dřív nešlo – kontrolku uměla ovládat jen lokální bluetoothová cesta, takže fungovala všude kromě instalací, kde displej visí na gatewayi v jiné místnosti.
- **Zrušení čekajícího zápisu přímo u automatiky**: karta automatického zápisu ukazuje, co má displej ve frontě, a u čekajícího zápisu je křížek. Dřív se z fronty četlo jen „která adresa právě zapisuje“, takže zápis čekající na řadu tu vidět nebyl a jediná stránka, kde se automatika sleduje, byla zároveň jediná, odkud ji nešlo zastavit. Zápis, který už běží, se zobrazuje bez křížku záměrně: přerušit přenos uprostřed bloku zmrazí řadič displeje.
- **Do protokolu přenosu přibyl použitý packer**: každý zápis nově zaznamená, jakým způsobem se obrázek zabalil, včetně rozměru a typu panelu. Displej nakrmený špatným balením nehlásí chybu – přijme obrázek a vytiskne ho – takže se to dosud nedalo od poruchy panelu rozeznat.

### Vylepšeno
- **Upozornění na chybějící Bluetooth respektuje gatewaye**: hlášku spouštěl jen počet skenerů, takže pro každého, kdo displeje obsluhuje gatewayí, svítila natrvalo a nešlo s ní nic dělat. Gateway posílá obrázky po síti a žádný adaptér v Home Assistantu nepotřebuje. Počet gatewayí teď dorazí ve stejné odpovědi jako počet skenerů, takže se panel rozhodne najednou a hláška ani neprobleskne při načítání. Bez adaptéru i bez gatewaye se upozornění zobrazí dál.
- **Levý panel v designeru zůstane, kde byl**: každé kliknutí v paletě prvků – výběr bloku, výběr vrstvy – překreslilo stránku a odrolovaný seznam skočil zpět nahoru pod kurzorem. Mechanismus, který si polohu pamatuje, tu byl už dřív, ale hlídal jen prvky s vlastním identifikátorem a paleta žádný neměla. Poloha se drží pro každou kategorii zvlášť, takže přepnutí z Bloků na Vrstvy začíná nahoře a nezdědí odrolování druhého seznamu.

### Opraveno
- **Poloprůhledné plochy v designeru zmizely z displeje**: plocha pod křivkou grafu, dráha pod ukazatelem a podklad zapnutého přepínače se kreslily jako světlejší odstín své barvy. Panel ale žádný světlejší odstín nemá – prahuje na hodnotě 161 a všechno nad ní posílá do bílé. Černá na 22 % vychází na rgb(203,203,203), červená na rgb(246,204,203), žlutá na rgb(253,242,199): všechny tři bílé. Plochy se tedy spočítaly, vykreslily a pak zahodily. Nahradil je rastr plnou barvou, kde je každý pixel buď inkoust, nebo papír – hustota tak přežije až na panel.
- **Prvky designeru se přestaly překrývat a přetékat**: hodnota na baterii se kreslila stejnou barvou jako náplň, takže při 63 % zmizela v černé a koukalo jen „%“. Rtuť teploměru vycházela na jednopixelový vlásek. Popisek prstencového grafu ležel přes vlastní prstenec a spodní hrana ho půlila. Oblouk budíku přesahoval nad horní okraj prvku. Stupnice posuvníku a číslice čárového kódu se tiskly půlkou pod spodní hranou. Společná příčina: pásma se rozpočítávala, jako by písmo šlo zmenšit libovolně, jenže vykreslovač pod 10 px nejde. Pásmo, do kterého se čitelný znak nevejde, se teď vynechá – žádná stupnice je lepší než půlka stupnice.
- **Popisky pod sloupcovým grafem se tiskly přes sebe**: na plně popsané ose – sedm dnů v týdnu – si každý popisek nárokoval 3,5 sloupce, a pojistka, která širokou popisku drží uvnitř grafu, pak první dva srovnala na stejné místo a poslední dva taky. „Po“ se tisklo přes „Út“ a „So“ přes „Ne“. Popisek si nově půjčuje jen ta místa, která opravdu nikdo nepopisuje.
- **Vložený obrázek se překresluje ve své skutečné velikosti**: rastr se počítal jednou při vložení do náhledu o delší straně 240 px a pak se do prvku jen zvětšoval nejbližším sousedem. Zmenšený rastr ale není menší rastr – rozpadne se na plochy, které se naprahují na plnou černou nebo na nic.
- **Vlastní prvky doputují na displej i mimo designer**: seznam prvků se četl z HTML stránky. Když plocha designeru zrovna nebyla vykreslená – což je případ každé náhledové kachle – nevrátil se žádný prvek a z náhledu zmizely. Ve vícešablonovém rozvržení se navíc držely prvky jen té šablony, která byla zrovna otevřená, a procenta se počítala z celého displeje místo z políčka, kam prvek patří. Čte se teď z modelu.
- **Gateway přestala rušit zdravé přenosy** (firmware 0.1.63): hlídač počítal dobu bez postupu ze dvou časových razítek, ale první si přečetl ještě před uzamčením. Přenosová úloha mezitím stihla zapsat razítko novější, odečet bez znaménka přetekl a z pár milisekund vyšlo 4 294 967 sekund. Hlídač to přečetl jako sedmitýdenní zámrz a restartoval bránu uprostřed zápisu, který normálně postupoval; v protokolu to skončilo jako `gateway_transfer_lost_after_restart`. Po aktualizaci integrace nezapomeňte v panelu spustit „Nahrát firmware“, jinak brána běží dál na staré verzi.
