export const variablesMixin = {
  ...
  _renderVariablesDialog() {
    ...
    return `<div class="modal-backdrop"><div class="editor-dialog">
      ...
      </div>`).join("")}</div>` : `<div class="inspector-empty"><ha-icon icon="mdi:variable-off"></ha-icon><p>Návrh zatím neobsahuje žádnou proměnnou. Označte text jako proměnný nebo vložte graf.</p></div>`}
    </div></div>`;
  },
