  ...
  _renderCustomLayerDesign(layers, activeLayer, selected) {
    ...
    const inspector = selected ? `<div class="layer-inspector">
      ...
      ${selected.type === "text" ? `
        ...
        <div class="field"><label>Entita Home Assistantu (volitelné)</label><ha-selector data-layer-object-entity="${selected.id}"></ha-selector></div>
