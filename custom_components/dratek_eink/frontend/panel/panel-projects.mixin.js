  ...
  _exportDisplayTemplate(templateId) {
    ...
    const payload = {
      ...
      template: {
        ...
        elements: template.editor_elements || template.elements || [],
        editor_elements: template.editor_elements || template.elements || [],
        action: template.action === "dratek_logo_broadcast" ? template.action : "",
        base_template_id: template.base_template_id || "",
        design_width: template.design_width || 296,
        design_height: template.design_height || 128,
        design_orientation: template.design_orientation || "landscape",
        element_adjustments: template.element_adjustments || {},
        user_created: true,
      },
    };
  ...
  async _importDisplayTemplateFile(file) {
    ...
    try {
      ...
      const importedTemplate = {
        ...
        editor_elements: Array.isArray(rawTemplate.editor_elements) ? rawTemplate.editor_elements
          : Array.isArray(rawTemplate.elements) ? rawTemplate.elements : [],
        action: rawTemplate.action === "dratek_logo_broadcast" ? rawTemplate.action : "",
        base_template_id: String(rawTemplate.base_template_id || ""),
        design_width: Number(rawTemplate.design_width) || 296,
        design_height: Number(rawTemplate.design_height) || 128,
        design_orientation: rawTemplate.design_orientation === "portrait" ? "portrait" : "landscape",
        element_adjustments: rawTemplate.element_adjustments || {},
        user_created: true,
