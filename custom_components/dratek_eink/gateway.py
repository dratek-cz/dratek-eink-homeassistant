...
async def _async_probe_gateway_url(hass: HomeAssistant, base_url: str) -> dict[str, Any]:
    ...
    return {
        ...
        "wifi_power_save": payload.get("wifi_power_save"),
        "wifi_disconnect_count": payload.get("wifi_disconnect_count"),
        "last_wifi_disconnect_ms": payload.get("last_wifi_disconnect_ms"),
